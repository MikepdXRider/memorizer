...
export default function Game() {
  ...
  useEffect(() => {
    ...
    function giveHints(arr: any, i = 0) {
      ...
      setTimeout(() => {
        ...
        i < arr.length ? giveHints(correctAnswers, i + 1) : (i = 0);
      }, 1000);
    }
  ...
  useEffect(() => {
    console.log(
      'userArr: ' + userGuesses.length,
      'correctArr: ' + correctAnswers.length,
      'userClicks: ' + clicks
    );
      ...
      {loss && (
        <section className="modal-background">
          <div>
            <h3>You lost!</h3>
            <p>
              You're last selection was {userGuesses[clicks - 1]}, the correct
              number was {correctAnswers[clicks]}
            </p>
